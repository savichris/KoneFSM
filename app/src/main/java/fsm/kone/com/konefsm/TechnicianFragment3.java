...
public class TechnicianFragment3 extends Fragment {

    private String productName;
    private TrainingController mController;
    private View characterView;

    public static TechnicianFragment3 getInstance(String productName) {
        TechnicianFragment3 fragment = new TechnicianFragment3();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.technician_training_3, null);
                ...
                if (mitigation1Txt.getVisibility() == View.VISIBLE &&
                    ...
                    view.animate().translationX(view.getX()+rootView.getWidth())
                        ...
                        public void run() {
                            ...
                            mController.advanceTraining("technician", 4, characterView);
